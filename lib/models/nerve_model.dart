...
class Nerve {
  ...
  factory Nerve.fromJson(Map<String, dynamic> json) {
    return Nerve(
      ...
      name: json['titulo'] ?? json['name'] ?? 'Unknown Nerve',
      description: json['descripcion'] ?? json['description'] ?? 'No data available.',
      isVital: json['isVital'] ?? false,
      sense: json['sentido'] ?? json['sense'] ?? 'unknown',
